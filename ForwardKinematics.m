...
%syms Q1 Q2 Q3 Q4       
Q1=0; Q2=0; Q3=0; Q4=0;
T01 = trchain ('Rz(Q1)*Tz(-L1)', [Q1]);
T12 = trchain ('Ry(Q2)*Tx(L2)', [Q2]);
T23 = trchain ('Ry(Q3)*Tx(L3)', [Q3]);
T34 = trchain ('Ry(Q4)*Tx(L4)', [Q4]);

%Checking if T04 is the same as kinematics
T04 = T01*T12*T23*T34
kineAttampt = attamptArm.fkine(qz)
